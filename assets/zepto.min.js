(function (e) {
    if (String.prototype.trim === e) String.prototype.trim = function () {
        return this.replace(/^\s+|\s+$/g, "")
    };
    if (Array.prototype.reduce === e) Array.prototype.reduce = function (t) {
        ...
        while (i < r) {
            if (i in n) s = t.call(e, s, n[i], i, n);
            i++
        }
        return s
    }
...
var Zepto = function () {
    ...
    function Q(e) {
        var t;
        try {
            return e ? e == "true" || (e == "false" ? false : e == "null" ? null : !isNaN(t = Number(e)) ? t : /^[\[\{]/.test(e) ? n.parseJSON(e) : e) : e
        } catch (r) {
            return e
        }
    }
    ...
    C.fragment = function (t, r, i) {
        ...
        if (r === e) r = h.test(t) && RegExp.$1;
        if (!(r in b)) r = "*";
        var o, u, a = b[r];
        a.innerHTML = "" + t;
        u = n.each(s.call(a.childNodes), function () {
            a.removeChild(this)
        });
        if (H(i)) {
            o = n(u);
            n.each(i, function (e, t) {
                if (v.indexOf(e) > -1) o[e](t);
                else o.attr(e, t)
            })
        }
        return u
    ...
    C.init = function (t, r) {
        if (!t) return C.Z();
        else if (M(t)) return n(u).ready(t);
        else if (C.isZ(t)) return t;
        else {
            var i;
            if (B(t)) i = F(t);
    ...
    n.fn = {
        ...
        filter: function (e) {
            if (M(e)) return this.not(this.not(e));
        ...
        find: function (e) {
            var t, r = this;
            if (typeof e == "object") t = n(e).filter(function () {
                var e = this;
                return i.some.call(r, function (t) {
                    return n.contains(t, e)
                })
            });
            else if (this.length == 1) t = n(C.qsa(this[0], e));
        ...
        show: function () {
            return this.each(function () {
                ...
                if (l(this, "").getPropertyValue("display") == "none") this.style.display = z(this.nodeName)
            })
        },
    ...
    ["width", "height"].forEach(function (t) {
        n.fn[t] = function (r) {
            ...
            if (r === e) return _(s) ? s["inner" + o] : D(s) ? s.documentElement["offset" + o] : (i = this.offset()) && i[t];
...
(function (e) {
    function t(e) {
        ...
        if (o) t.ios = t.iphone = true, t.version = o[2].replace(/_/g, ".");
        if (s) t.ios = t.ipad = true, t.version = s[2].replace(/_/g, ".");
        if (u) t.webos = true, t.version = u[2];
        if (a) t.touchpad = true;
        if (c) t.blackberry = true, t.version = c[2];
        if (h) t.bb10 = true, t.version = h[2];
        if (p) t.rimtabletos = true, t.version = p[2];
        if (d) n.playbook = true;
        if (f) t.kindle = true, t.version = f[1];
        if (l) n.silk = true, n.version = l[1];
        if (!l && t.android && e.match(/Kindle Fire/)) n.silk = true;
        if (v) n.chrome = true, n.version = v[1];
        if (m) n.firefox = true, n.version = m[1];
...
(function (e) {
    ...
    function l(t, n, r) {
        if (e.type(t) != "string") e.each(t, r);
        else t.split(/\s/).forEach(function (e) {
            r(e, n)
        })
    }
    ...
    function p(t, r, i, u, f, p) {
        ...
        l(r, i, function (n, r) {
            ...
            i.proxy = function (e) {
                ...
                if (n === false) e.preventDefault(), e.stopPropagation();
                return n
            };
            i.i = v.length;
            v.push(i);
    ...
    function b(t) {
        ...
        for (n in t)
            if (!g.test(n) && t[n] !== undefined) r[n] = t[n];
    ...
    e.fn.triggerHandler = function (t, n) {
        ...
        this.each(function (s, o) {
            ...
            r.data = n;
            r.target = o;
            e.each(u(o, t.type || t), function (e, t) {
                i = t.proxy(r);
    ...
    e.Event = function (e, t) {
        if (typeof e != "string") t = e, e = t.type;
        var n = document.createEvent(i[e] || "Events"),
            r = true;
        if (t)
            for (var s in t) s == "bubbles" ? r = !!t[s] : n[s] = t[s];
        n.initEvent(e, r, true, null, null, null, null, null, null, null, null, null, null, null, null);
...
(function ($) {
    ...
    function parseArguments(e, t, n, r, i, s) {
        var o = !$.isFunction(t);
        return {
            url: e,
            data: o ? t : undefined,
            success: !o ? t : $.isFunction(n) ? n : undefined,
            error: !o ? t : $.isFunction(r) ? r : undefined,
            timeout: o ? i : undefined,
            dataType: o ? s || n : n
        }
    }
    ...
    function serialize(e, t, n, r) {
        ...
        $.each(t, function (t, o) {
            i = $.type(o);
            if (r) t = n ? r : r + "[" + (s ? "" : t) + "]";
            if (!r && s) e.add(o.name, o.value);
            else if (i == "array" || !n && i == "object") serialize(e, o, n, t);
            else e.add(t, o)
        })
    }
    var jsonpID = 0,
    ...
    $.post = function (e, t, n, r, i, s) {
        function a(e) {
            return (new Function("return " + e))()
        }
        var o = parseArguments.apply(null, arguments);
        o.type = "POST";
        var u = o.success;
...
(function (e) {
    e.fn.serializeArray = function () {
        var t = [],
            n;
        e(Array.prototype.slice.call(this.get(0).elements)).each(function () {
            n = e(this);
            var r = n.attr("type");
    ...
    e.fn.submit = function (t) {
        if (t) this.bind("submit", t);
            ...
            this.eq(0).trigger(n);
            if (!n.defaultPrevented) this.get(0).submit()
        }
        return this
    }
})(Zepto);
(function (e, t) {
    ...
    e.fn.animate = function (t, n, r, i) {
        if (e.isPlainObject(n)) r = n.easing, i = n.complete, n = n.duration;
        if (n) n = (typeof n == "number" ? n : e.fx.speeds[n] || e.fx.speeds._default) / 1e3;
        return this.anim(t, n, r, i)
    };
...
(function (e) {
    function i(t) {
        t = e(t);
        return !!(t.width() || t.height()) && t.css("display") !== "none"
    }
    ...
    t.qsa = function (r, i) {
        return f(i, function (s, o, f) {
            try {
                var l;
                if (!s && o) s = "*";
                else if (u.test(s)) l = e(r).addClass(a), s = "." + a + " " + s;
                var c = n(r, s)
            } catch (h) {
                console.error("error performing selector: %o", i);
                throw h
            } finally {
                if (l) l.removeClass(a)
            }
            return !o ? c : t.uniq(e.map(c, function (e, t) {
